...
final List<Product> shoes = [
  ...
  Product(
    ...
    description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "images/shoes/vansold_skool.png",
    price: 300,
    seller: "Mrs Store",
    colors: [
      Colors.blueAccent,
...
final List<Product> beauty = [
  ...
  Product(
   ...
   Product(
    ...
    description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "images/beauty/skin_care.png",
    price: 999,
    seller: "Mr Beast",
    colors: [
      Colors.black12,
...
final List<Product> womenFashion = [
  ...
  Product(
    ...
    description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "images/women_fashion/t_shert.png",
    price: 155,
    seller: "Love Store",
    colors: [
      Colors.blueAccent,
...
Product(
  ...
  Product(
    ...
    description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "images/jewelry/jewelry_box.png",
    price: 300,
    seller: "Love Love",
    colors: [
      Colors.pink,
   ...
   Product(
    ...
    description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "images/jewelry/necklace_jewellery.png",
    price: 5000,
...
final List<Product> menFashion = [
  ...
  Product(
   ...
   Product(
    ...
    description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "images/men_fashion/t_shirt.png",
    price: 200,
    seller: "Hot Store",
    colors: [
      Colors.brown,
